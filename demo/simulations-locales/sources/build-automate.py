...
header = '''<body><header><nav><a href="ondes-3d.html">Surfaces ondulantes</a><a href="cycle-3d.html">Cycle 3D précédent</a><a href="index.html">Version 2D</a><a href="REGLES-AUTOMATE.md">Guide des règles</a></nav><h1>Assemblages locaux — émergence et devenir</h1><p>Des portions de branes ferment une géométrie, puis un domaine peut activer l’attraction et une capture locale 50/50. Comparez domaines uniques ou multiples, dissymétrie et durée ; les anciennes règles d’assemblage restent disponibles. Automate exploratoire 3D, version 5.</p></header>'''
document = head + header + (source / "automate.html").read_text()
for name in ("waves-geometry.js", "local-branes.js", "structures-engine.js", "automate-app.js"):
